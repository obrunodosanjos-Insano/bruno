...
import { Sparkles, ArrowRight, Star, MapPin, Calendar, Flame, Laptop, Gift, Zap, Cake, Wifi } from 'lucide-react';
...
export const Hero: React.FC<HeroProps> = ({
  ...
  return (
    <section id="hero" className="relative bg-[#fafafa] dark:bg-[#141210] text-stone-900 dark:text-stone-100 overflow-hidden py-10 lg:py-16 border-b border-stone-200/60 dark:border-stone-800/80 transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-6 space-y-5 text-center lg:text-left">
            ...
            <p className="text-sm sm:text-base text-stone-600 dark:text-stone-300 max-w-lg mx-auto lg:mx-0 leading-relaxed font-normal">
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3 pt-1">
              <button
                ...
                className="px-7 py-3 rounded-full bg-stone-950 dark:bg-stone-100 hover:bg-stone-800 dark:hover:bg-white text-white dark:text-stone-950 font-bold text-xs uppercase tracking-wider transition-all duration-200 shadow-sm flex items-center gap-2 cursor-pointer active:scale-95"
                id="btn-hero-menu"
              >
              ...
              <button
                ...
                className="px-7 py-3 rounded-full bg-white dark:bg-stone-900 hover:bg-stone-100 dark:hover:bg-stone-800 text-stone-900 dark:text-stone-100 border border-stone-200 dark:border-stone-700 font-bold text-xs uppercase tracking-wider transition-all duration-200 flex items-center gap-2 cursor-pointer active:scale-95"
                id="btn-hero-reservation"
              >
                <Calendar className="w-4 h-4 text-stone-900 dark:text-stone-100" />
            ...
            <div className="pt-6 border-t border-stone-200 dark:border-stone-800">
              <p className="text-[11px] font-bold uppercase tracking-widest text-stone-400 dark:text-stone-500 mb-3 text-center lg:text-left font-display flex items-center justify-center lg:justify-start gap-1.5">
                <Zap className="w-3.5 h-3.5 text-stone-500 dark:text-amber-400" />
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                <button
                  ...
                  className="px-3 py-2 rounded-2xl bg-white dark:bg-stone-850 dark:bg-stone-900 hover:bg-stone-100 dark:hover:bg-stone-800 border border-stone-200 dark:border-stone-800 text-stone-900 dark:text-stone-100 text-xs font-bold flex items-center gap-2 transition-all shadow-2xs cursor-pointer text-left"
                >
                ...
                >
                  <Laptop className="w-4 h-4 text-stone-900 dark:text-stone-200 shrink-0" />
                ...
                <button
                  ...
                  className="px-3 py-2 rounded-2xl bg-white dark:bg-stone-900 hover:bg-stone-100 dark:hover:bg-stone-800 border border-stone-200 dark:border-stone-800 text-stone-900 dark:text-stone-100 text-xs font-bold flex items-center gap-2 transition-all shadow-2xs cursor-pointer text-left"
                >
                  <Cake className="w-4 h-4 text-stone-900 dark:text-stone-200 shrink-0" />
                ...
                <button
                  ...
                  className="px-3 py-2 rounded-2xl bg-white dark:bg-stone-900 hover:bg-stone-100 dark:hover:bg-stone-800 border border-stone-200 dark:border-stone-800 text-stone-900 dark:text-stone-100 text-xs font-bold flex items-center gap-2 transition-all shadow-2xs cursor-pointer text-left"
                >
                  <Wifi className="w-4 h-4 text-stone-900 dark:text-stone-200 shrink-0" />
                ...
                <button
                  ...
                  className="px-3 py-2 rounded-2xl bg-white dark:bg-stone-900 hover:bg-stone-100 dark:hover:bg-stone-800 border border-stone-200 dark:border-stone-800 text-stone-900 dark:text-stone-100 text-xs font-bold flex items-center gap-2 transition-all shadow-2xs cursor-pointer text-left"
                >
                  <MapPin className="w-4 h-4 text-stone-900 dark:text-stone-200 shrink-0" />
          ...
          <div className="lg:col-span-6 relative">
            <div className="relative mx-auto max-w-md lg:max-w-none">
              ...
              <div className="we-card rounded-3xl overflow-hidden p-2 bg-white dark:bg-stone-900 relative shadow-md">
